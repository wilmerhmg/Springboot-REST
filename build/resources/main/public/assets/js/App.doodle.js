$(function () {
	...
	$.ajax({
		url: CONST.URL('search/modalidades'),
		dataType:'json',type:'POST'
	}).success(function (data) {
		$("[name='clas_id']").select2({
			data: data, placeholder: "Seleccionar modalidad..."
		});
	});
	
	$("[name='director_id']").select2({
